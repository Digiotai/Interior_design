...
# from .models import send_welcome_email
# from django.views.decorators.csrf import csrf_exempt
# from django.http import HttpResponse
# import json
...
#         number_of_room_designs = request.POST.get('number_of_room_designs')
#         image_url = request.POST.get('image_url')

       
#         current_date = datetime.now().strftime("%d/%m/%Y")
#         subject = f'Interior design - {current_date}'
#         message = f'Hi,\n\nThank you for using our interior design platform!\n\n' \
#                   f'Please find the generated image attached.\n\n. Count = {number_of_room_designs}\n' \
#                   f'Selected type: {selected_room_type}\n' \
#                   f'Selected style: {selected_style}\n' \
#                   f'Selected color: {selected_room_color}\n\n' \
#                   f'Image URL: {image_url}'

#         send_welcome_email(email, subject, message)

#         messages.success(request, 'Interior design email sent successfully.')
    ...
    if request.method == 'POST':
        try:
           ...
           # number_of_room_designs = request.POST.get("number_of_room_designs")
            ...
            current_date = datetime.now().strftime("%d/%m/%Y")
            subject = f'Interior design - {current_date}'
            message = f'Please find the generated image attached. Count = 1\n' \
                      f'Selected type: {selected_room_type}\n' \
                      f'Selected style: {selected_style}\n' \
                      f'Selected color: {selected_room_color}'
            ...
            generated_image = GeneratedImage(
                ...
                #number_of_room_designs=number_of_room_designs,
            )
